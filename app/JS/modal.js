$(document).ready(function() {
    ...
    $(document).on("click", "button#add_phone_number", function(e) {
        ...
        html += '<input class="w3-input w3-border" name="phone_number" type="text" maxlength="11" required />';
        html += '</div>';
    ...
    $(document).on("click", "button#add_email", function(e) {
        ...
        html += '<div class="w3-twothird">';
        html += '<input class="w3-input w3-border" name="email" type="email" required />';
        html += '</div>';
